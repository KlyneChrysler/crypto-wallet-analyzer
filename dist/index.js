...
exports.analyzeCryptoWallet = analyzeCryptoWallet;
async function analyzeCryptoWallet(address) {
...
async function analyzeBitcoinWallet(address) {
...
async function convertBTCtoUSD(btc) {
